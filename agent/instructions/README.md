...
| [financials.md](./financials.md) | Quarterly / `financials/*.yaml` |
...
| [financials_update.md](./financials_update.md) | Validate & fill quarter YAML under **`inbox/`** (not **`content/`** unless user explicitly allows) |
